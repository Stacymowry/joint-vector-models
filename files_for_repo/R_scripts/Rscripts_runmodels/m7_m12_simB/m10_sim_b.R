...
model_file = "m4path_sim_cd_shared.stan"
...
write.csv(out_1,"mcmc_samples_m4path_c_1.csv")

write.csv(out_2,"yhat_m4path_c_1.csv")
...
write.csv(out_1,"mcmc_samples_m4path_b_2.csv")
write.csv(out_2,"yhat_m4path_b_2.csv")
...
write.csv(out_1,"mcmc_samples_m4path_b_3.csv")
write.csv(out_2,"yhat_m4path_b_3.csv")
...
write.csv(out_1,"mcmc_samples_m4path_b_4.csv")

write.csv(out_2,"yhat_m4path_b_4.csv")
...
write.csv(out_1,"mcmc_samples_m4path_b_5.csv")

write.csv(out_2,"yhat_m4path_b_5.csv")
...
write.csv(out_1,"mcmc_samples_m4path_b_6.csv")

write.csv(out_2,"yhat_m4path_b_6.csv")
...
write.csv(out_1,"mcmc_samples_m4path_b_7.csv")

write.csv(out_2,"yhat_m4path_b_7.csv")
...
write.csv(out_1,"mcmc_samples_m4path_b_8.csv")

write.csv(out_2,"yhat_m4path_b_8.csv")
...
write.csv(out_1,"mcmc_samples_m4path_b_9.csv")

write.csv(out_2,"yhat_m4path_b_9.csv")
...
write.csv(out_1,"mcmc_samples_m4path_b_10.csv")

write.csv(out_2,"yhat_m4path_b_10.csv")
