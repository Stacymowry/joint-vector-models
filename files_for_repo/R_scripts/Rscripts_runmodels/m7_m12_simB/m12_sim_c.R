##Title: R script to run 10x m7 C
##Author: Stacy Mowry
## 5/15/2023
...
data_1<-read.csv("Sim_C_1.csv")
data_2<-read.csv("Sim_C_2.csv")
data_3<-read.csv("Sim_C_3.csv")
data_4<-read.csv("Sim_C_4.csv")
data_5<-read.csv("Sim_C_5.csv")
data_6<-read.csv("Sim_C_6.csv")
data_7<-read.csv("Sim_C_7.csv")
data_8<-read.csv("Sim_C_8.csv")
data_9<-read.csv("Sim_C_9.csv")
data_10<-read.csv("Sim_C_10.csv")
...
model_file = "m6path_sim_cd_shared.stan"
...
write.csv(out_1,"mcmc_samples_m6path_c_1.csv")

write.csv(out_2,"yhat_m6path_c_1.csv")
...
write.csv(out_1,"mcmc_samples_m6path_c_2.csv")

write.csv(out_2,"yhat_m6path_c_2.csv")
...
write.csv(out_1,"mcmc_samples_m6path_c_3.csv")

write.csv(out_2,"yhat_m6path_c_3.csv")
...
write.csv(out_1,"mcmc_samples_m6path_c_4.csv")

write.csv(out_2,"yhat_m6path_c_4.csv")
...
write.csv(out_1,"mcmc_samples_m6path_c_5.csv")

write.csv(out_2,"yhat_m6path_c_5.csv")
...
write.csv(out_1,"mcmc_samples_m6path_c_6.csv")

write.csv(out_2,"yhat_m6path_c_6.csv")
...
write.csv(out_1,"mcmc_samples_m6path_c_7.csv")

write.csv(out_2,"yhat_m6path_c_7.csv")
...
write.csv(out_1,"mcmc_samples_m6path_c_8.csv")

write.csv(out_2,"yhat_m6path_c_8.csv")
...
write.csv(out_1,"mcmc_samples_m6path_c_9.csv")

write.csv(out_2,"yhat_m6path_c_9.csv")
...
write.csv(out_1,"mcmc_samples_m6path_c_10.csv")

write.csv(out_2,"yhat_m6path_c_10.csv")
