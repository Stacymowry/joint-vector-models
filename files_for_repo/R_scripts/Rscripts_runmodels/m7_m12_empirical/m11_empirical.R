...
model = stan_model("m5path_shared.stan")

##run 4 chains, each 1000 iterations
fit = sampling(model,dat,iter=7000,cores=4,chains=4)
...
##save samples to csv
write.csv(params,"~/fl_models/m5path_shared.mcmc.split1.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m5path_shared.mcmc.split2.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m5path_shared.mcmc.split3.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m5path_shared.mcmc.split4.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m5path_shared.mcmc.split5.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m5path_shared.mcmc.split6.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m5path_shared.mcmc.split7.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m5path_shared.mcmc.split8.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m5path_shared.mcmc.split9.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m5path_shared.mcmc.split10.csv")
