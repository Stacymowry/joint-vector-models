##Title: R script to run Stan models for CRC
##Author: Stacy Mowry
## 10/24/2022
...
data<-read.csv("fl2_train_test_newpoints.csv")
...
model = stan_model("m4path_shared.stan")

##run 4 chains, each 1000 iterations
fit = sampling(model,dat,iter=5000,chains=4,cores=4 )
...
##save samples to csv
write.csv(params,"~/fl_models/m4path_shared.mcmc.split1.csv")
...
##run 4 chains, each 1000 iterations
fit = sampling(model,dat,iter=5000,cores=4,chains=4)
...
##save samples to csv
write.csv(params,"~/fl_models/m4path_shared.mcmc.split2.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m4path_shared.mcmc.split3.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m4path_shared.mcmc.split4.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m4path_shared.mcmc.split5.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m4path_shared.mcmc.split6.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m4path_shared.mcmc.split7.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m4path_shared.mcmc.split8.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m4path_shared.mcmc.split9.csv")
...
##save samples to csv
write.csv(params,"~/fl_models/m4path_shared.mcmc.split10.csv")
