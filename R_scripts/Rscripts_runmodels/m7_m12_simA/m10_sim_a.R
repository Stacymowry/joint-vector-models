...
model_file = "m4path_sim_a_shared.stan"
...
write.csv(out_1,"mcmc_samples_m4path_a_1.csv")

write.csv(out_2,"yhat_m4path_a_1.csv")
...
write.csv(out_1,"mcmc_samples_m4path_a_2.csv")

write.csv(out_2,"yhat_m4path_a_2.csv")
...
write.csv(out_1,"mcmc_samples_m4path_a_3.csv")

write.csv(out_2,"yhat_m4path_a_3.csv")
...
write.csv(out_1,"mcmc_samples_m4path_a_4.csv")

write.csv(out_2,"yhat_m4path_a_4.csv")
...
write.csv(out_1,"mcmc_samples_m4path_a_5.csv")

write.csv(out_2,"yhat_m4path_a_5.csv")
...
write.csv(out_1,"mcmc_samples_m4path_a_6.csv")

write.csv(out_2,"yhat_m4path_a_6.csv")
...
write.csv(out_1,"mcmc_samples_m4path_a_7.csv")

write.csv(out_2,"yhat_m4path_a_7.csv")
...
write.csv(out_1,"mcmc_samples_m4path_a_8.csv")

write.csv(out_2,"yhat_m4path_a_8.csv")
...
write.csv(out_1,"mcmc_samples_m4path_a_9.csv")

write.csv(out_2,"yhat_m4path_a_9.csv")
...
write.csv(out_1,"mcmc_samples_m4path_a_10.csv")

write.csv(out_2,"yhat_m4path_a_10.csv")
