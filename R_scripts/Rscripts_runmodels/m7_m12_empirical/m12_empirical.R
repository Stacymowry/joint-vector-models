...
train_5<-read.csv("train_5.csv")
train_6<-read.csv("train_6.csv")
train_7<-read.csv("train_7.csv")
train_8<-read.csv("train_8.csv")
train_9<-read.csv("train_9.csv")
train_10<-read.csv("train_10.csv")
...
model = stan_model("m12_revisions_10.stan")
...
##save samples to csv
write.csv(params,"~/fl_models/m12_revisions_10.mcmc.csv")