...
model_file = "m5path_sim_cd_shared.stan"
...
write.csv(out_1,"mcmc_samples_m5path_c_1.csv")

write.csv(out_2,"yhat_m5path_c_1.csv")
...
write.csv(out_1,"mcmc_samples_m5path_c_2.csv")

write.csv(out_2,"yhat_m5path_c_2.csv")
...
write.csv(out_1,"mcmc_samples_m5path_c_3.csv")

write.csv(out_2,"yhat_m5path_c_3.csv")
...
write.csv(out_1,"mcmc_samples_m5path_c_4.csv")

write.csv(out_2,"yhat_m5path_c_4.csv")
...
write.csv(out_1,"mcmc_samples_m5path_c_5.csv")

write.csv(out_2,"yhat_m5path_c_5.csv")
...
write.csv(out_1,"mcmc_samples_m5path_c_6.csv")

write.csv(out_2,"yhat_m5path_c_6.csv")
...
write.csv(out_1,"mcmc_samples_m5path_c_7.csv")

write.csv(out_2,"yhat_m5path_c_7.csv")
...
write.csv(out_1,"mcmc_samples_m5path_c_8.csv")

write.csv(out_2,"yhat_m5path_c_8.csv")
...
write.csv(out_1,"mcmc_samples_m5path_c_9.csv")

write.csv(out_2,"yhat_m5path_c_9.csv")
...
write.csv(out_1,"mcmc_samples_m5path_c_10.csv")

write.csv(out_2,"yhat_m5path_c_10.csv")
