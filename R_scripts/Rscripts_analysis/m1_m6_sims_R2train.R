...
sim_b_1<-read.csv("Sim_B_1.csv")
sim_b_2<-read.csv("Sim_B_2.csv")
sim_b_3<-read.csv("Sim_B_3.csv")
sim_b_4<-read.csv("Sim_B_4.csv")
sim_b_5<-read.csv("Sim_B_5.csv")
sim_b_6<-read.csv("Sim_B_6.csv")
sim_b_7<-read.csv("Sim_B_7.csv")
sim_b_8<-read.csv("Sim_B_8.csv")
sim_b_9<-read.csv("Sim_B_9.csv")
sim_b_10<-read.csv("Sim_B_10.csv")
...
pred.m1<-function(data_s,file_out)
{
  ...
  m1.mcmc<-read.csv("mcmc_samples_m1path_c_10.csv")
...
pred.m2<-function(data_s,file_out)
{
  ...
  forest = data_s$landcover_6 + data_s$landcover_14 + data_s$landcover_15
  wetland = data_s$landcover_18 
  m2.mcmc<-read.csv("mcmc_samples_m2path_c_10.csv")
...
pred.m3<-function(data_s,file_out)
{
  ...
  m3.mcmc<-read.csv("mcmc_samples_m3path_c_10.csv")
...
{
  m4.mcmc<-read.csv("mcmc_samples_m4path_c_10.csv")
...
{
  m5.mcmc<-read.csv("mcmc_samples_m5path_c_10.csv")
...
{
  m6.mcmc<-read.csv("mcmc_samples_m6path_c_10.csv")
...
##Run functions
pred.m1(data_s,"m7c_run10_full.csv")
pred.m2(data_s,"m8c_run10_full.csv")
pred.m3(data_s,"m9c_run10_full.csv")
pred.m4(data_s,"m10c_run10_full.csv")
pred.m5(data_s,"m11c_run10_full.csv")
pred.m6(data_s,"m12c_run10_full.csv")

##calculate train r^2 for each 
#Sim A
m1a_1<-read.csv("m7a_run1_full.csv")
m2a_1<-read.csv("m8a_run1_full.csv")
m3a_1<-read.csv("m9a_run1_full.csv")
m4a_1<-read.csv("m10a_run1_full.csv")
m5a_1<-read.csv("m11a_run1_full.csv")
m6a_1<-read.csv("m12a_run1_full.csv")

m1a_2<-read.csv("m7a_run2_full.csv")
m2a_2<-read.csv("m8a_run2_full.csv")
m3a_2<-read.csv("m9a_run2_full.csv")
m4a_2<-read.csv("m10a_run2_full.csv")
m5a_2<-read.csv("m11a_run2_full.csv")
m6a_2<-read.csv("m12a_run2_full.csv")

m1a_3<-read.csv("m7a_run3_full.csv")
m2a_3<-read.csv("m8a_run3_full.csv")
m3a_3<-read.csv("m9a_run3_full.csv")
m4a_3<-read.csv("m10a_run3_full.csv")
m5a_3<-read.csv("m11a_run3_full.csv")
m6a_3<-read.csv("m12a_run3_full.csv")

m1a_4<-read.csv("m7a_run4_full.csv")
m2a_4<-read.csv("m8a_run4_full.csv")
m3a_4<-read.csv("m9a_run4_full.csv")
m4a_4<-read.csv("m10a_run4_full.csv")
m5a_4<-read.csv("m11a_run4_full.csv")
m6a_4<-read.csv("m12a_run4_full.csv")

m1a_5<-read.csv("m7a_run5_full.csv")
m2a_5<-read.csv("m8a_run5_full.csv")
m3a_5<-read.csv("m9a_run5_full.csv")
m4a_5<-read.csv("m10a_run5_full.csv")
m5a_5<-read.csv("m11a_run5_full.csv")
m6a_5<-read.csv("m12a_run5_full.csv")

m1a_6<-read.csv("m7a_run6_full.csv")
m2a_6<-read.csv("m8a_run6_full.csv")
m3a_6<-read.csv("m9a_run6_full.csv")
m4a_6<-read.csv("m10a_run6_full.csv")
m5a_6<-read.csv("m11a_run6_full.csv")
m6a_6<-read.csv("m12a_run6_full.csv")

m1a_7<-read.csv("m7a_run7_full.csv")
m2a_7<-read.csv("m8a_run7_full.csv")
m3a_7<-read.csv("m9a_run7_full.csv")
m4a_7<-read.csv("m10a_run7_full.csv")
m5a_7<-read.csv("m11a_run7_full.csv")
m6a_7<-read.csv("m12a_run7_full.csv")

m1a_8<-read.csv("m7a_run8_full.csv")
m2a_8<-read.csv("m8a_run8_full.csv")
m3a_8<-read.csv("m9a_run8_full.csv")
m4a_8<-read.csv("m10a_run8_full.csv")
m5a_8<-read.csv("m11a_run8_full.csv")
m6a_8<-read.csv("m12a_run8_full.csv")

m1a_9<-read.csv("m7a_run9_full.csv")
m2a_9<-read.csv("m8a_run9_full.csv")
m3a_9<-read.csv("m9a_run9_full.csv")
m4a_9<-read.csv("m10a_run9_full.csv")
m5a_9<-read.csv("m11a_run9_full.csv")
m6a_9<-read.csv("m12a_run9_full.csv")

m1a_10<-read.csv("m7a_run10_full.csv")
m2a_10<-read.csv("m8a_run10_full.csv")
m3a_10<-read.csv("m9a_run10_full.csv")
m4a_10<-read.csv("m10a_run10_full.csv")
m5a_10<-read.csv("m11a_run10_full.csv")
m6a_10<-read.csv("m12a_run10_full.csv")

#Sim B
m1b_1<-read.csv("m1b_run1_full.csv")
m2b_1<-read.csv("m2b_run1_full.csv")
m3b_1<-read.csv("m3b_run1_full.csv")
m4b_1<-read.csv("m4b_run1_full.csv")
m5b_1<-read.csv("m5b_run1_full.csv")
m6b_1<-read.csv("m6b_run1_full.csv")

m1b_2<-read.csv("m1b_run2_full.csv")
m2b_2<-read.csv("m2b_run2_full.csv")
m3b_2<-read.csv("m3b_run2_full.csv")
m4b_2<-read.csv("m4b_run2_full.csv")
m5b_2<-read.csv("m5b_run2_full.csv")
m6b_2<-read.csv("m6b_run2_full.csv")

m1b_3<-read.csv("m1b_run3_full.csv")
m2b_3<-read.csv("m2b_run3_full.csv")
m3b_3<-read.csv("m3b_run3_full.csv")
m4b_3<-read.csv("m4b_run3_full.csv")
m5b_3<-read.csv("m5b_run3_full.csv")
m6b_3<-read.csv("m6b_run3_full.csv")

m1b_4<-read.csv("m1b_run4_full.csv")
m2b_4<-read.csv("m2b_run4_full.csv")
m3b_4<-read.csv("m3b_run4_full.csv")
m4b_4<-read.csv("m4b_run4_full.csv")
m5b_4<-read.csv("m5b_run4_full.csv")
m6b_4<-read.csv("m6b_run4_full.csv")

m1b_5<-read.csv("m1b_run5_full.csv")
m2b_5<-read.csv("m2b_run5_full.csv")
m3b_5<-read.csv("m3b_run5_full.csv")
m4b_5<-read.csv("m4b_run5_full.csv")
m5b_5<-read.csv("m5b_run5_full.csv")
m6b_5<-read.csv("m6b_run5_full.csv")

m1b_6<-read.csv("m1b_run6_full.csv")
m2b_6<-read.csv("m2b_run6_full.csv")
m3b_6<-read.csv("m3b_run6_full.csv")
m4b_6<-read.csv("m4b_run6_full.csv")
m5b_6<-read.csv("m5b_run6_full.csv")
m6b_6<-read.csv("m6b_run6_full.csv")

m1b_7<-read.csv("m1b_run7_full.csv")
m2b_7<-read.csv("m2b_run7_full.csv")
m3b_7<-read.csv("m3b_run7_full.csv")
m4b_7<-read.csv("m4b_run7_full.csv")
m5b_7<-read.csv("m5b_run7_full.csv")
m6b_7<-read.csv("m6b_run7_full.csv")

m1b_8<-read.csv("m1b_run8_full.csv")
m2b_8<-read.csv("m2b_run8_full.csv")
m3b_8<-read.csv("m3b_run8_full.csv")
m4b_8<-read.csv("m4b_run8_full.csv")
m5b_8<-read.csv("m5b_run8_full.csv")
m6b_8<-read.csv("m6b_run8_full.csv")

m1b_9<-read.csv("m1b_run9_full.csv")
m2b_9<-read.csv("m2b_run9_full.csv")
m3b_9<-read.csv("m3b_run9_full.csv")
m4b_9<-read.csv("m4b_run9_full.csv")
m5b_9<-read.csv("m5b_run9_full.csv")
m6b_9<-read.csv("m6b_run9_full.csv")

m1b_10<-read.csv("m1b_run10_full.csv")
m2b_10<-read.csv("m2b_run10_full.csv")
m3b_10<-read.csv("m3b_run10_full.csv")
m4b_10<-read.csv("m4b_run10_full.csv")
m5b_10<-read.csv("m5b_run10_full.csv")
m6b_10<-read.csv("m6b_run10_full.csv")

#Sim C
m1c_1<-read.csv("m7c_run1_full.csv")
m2c_1<-read.csv("m8c_run1_full.csv")
m3c_1<-read.csv("m9c_run1_full.csv")
m4c_1<-read.csv("m10c_run1_full.csv")
m5c_1<-read.csv("m11c_run1_full.csv")
m6c_1<-read.csv("m12c_run1_full.csv")

m1c_2<-read.csv("m7c_run2_full.csv")
m2c_2<-read.csv("m8c_run2_full.csv")
m3c_2<-read.csv("m9c_run2_full.csv")
m4c_2<-read.csv("m10c_run2_full.csv")
m5c_2<-read.csv("m11c_run2_full.csv")
m6c_2<-read.csv("m12c_run2_full.csv")

m1c_3<-read.csv("m7c_run3_full.csv")
m2c_3<-read.csv("m8c_run3_full.csv")
m3c_3<-read.csv("m9c_run3_full.csv")
m4c_3<-read.csv("m10c_run3_full.csv")
m5c_3<-read.csv("m11c_run3_full.csv")
m6c_3<-read.csv("m12c_run3_full.csv")

m1c_4<-read.csv("m7c_run4_full.csv")
m2c_4<-read.csv("m8c_run4_full.csv")
m3c_4<-read.csv("m9c_run4_full.csv")
m4c_4<-read.csv("m10c_run4_full.csv")
m5c_4<-read.csv("m11c_run4_full.csv")
m6c_4<-read.csv("m12c_run4_full.csv")

m1c_5<-read.csv("m7c_run5_full.csv")
m2c_5<-read.csv("m8c_run5_full.csv")
m3c_5<-read.csv("m9c_run5_full.csv")
m4c_5<-read.csv("m10c_run5_full.csv")
m5c_5<-read.csv("m11c_run5_full.csv")
m6c_5<-read.csv("m12c_run5_full.csv")

m1c_6<-read.csv("m7c_run6_full.csv")
m2c_6<-read.csv("m8c_run6_full.csv")
m3c_6<-read.csv("m9c_run6_full.csv")
m4c_6<-read.csv("m10c_run6_full.csv")
m5c_6<-read.csv("m11c_run6_full.csv")
m6c_6<-read.csv("m12c_run6_full.csv")

m1c_7<-read.csv("m7c_run7_full.csv")
m2c_7<-read.csv("m8c_run7_full.csv")
m3c_7<-read.csv("m9c_run7_full.csv")
m4c_7<-read.csv("m10c_run7_full.csv")
m5c_7<-read.csv("m11c_run7_full.csv")
m6c_7<-read.csv("m12c_run7_full.csv")

m1c_8<-read.csv("m7c_run8_full.csv")
m2c_8<-read.csv("m8c_run8_full.csv")
m3c_8<-read.csv("m9c_run8_full.csv")
m4c_8<-read.csv("m10c_run8_full.csv")
m5c_8<-read.csv("m11c_run8_full.csv")
m6c_8<-read.csv("m12c_run8_full.csv")

m1c_9<-read.csv("m7c_run9_full.csv")
m2c_9<-read.csv("m8c_run9_full.csv")
m3c_9<-read.csv("m9c_run9_full.csv")
m4c_9<-read.csv("m10c_run9_full.csv")
m5c_9<-read.csv("m11c_run9_full.csv")
m6c_9<-read.csv("m12c_run9_full.csv")

m1c_10<-read.csv("m7c_run10_full.csv")
m2c_10<-read.csv("m8c_run10_full.csv")
m3c_10<-read.csv("m9c_run10_full.csv")
m4c_10<-read.csv("m10c_run10_full.csv")
m5c_10<-read.csv("m11c_run10_full.csv")
m6c_10<-read.csv("m12c_run10_full.csv")
...
write.csv(r2_train,"train_r2_m1_m6.csv")
