...
{
  m1.mcmc<-read.csv("m1path_shared.mcmc.csv")
...
{
  m2.mcmc<-read.csv("m2path_shared.mcmc.csv")
...
{
  m3.mcmc<-read.csv("m3path_shared.mcmc.csv")
...
{
  m4.mcmc<-read.csv("m4path_shared.mcmc.csv")
...
{
  m5.mcmc<-read.csv("m5path_shared.mcmc.csv")
...
{
  m6.mcmc<-read.csv("m6path_shared.mcmc.csv")
...
##Run functions
pred.m1(data_s,"m1_preds_empirical.csv")
pred.m2(data_s,"m2_preds_empirical.csv")
pred.m3(data_s,"m3_preds_empirical.csv")
pred.m4(data_s,"m4_preds_empirical.csv")
pred.m5(data_s,"m5_preds_empirical.csv")
pred.m6(data_s,"m6_preds_empirical.csv")

################################################################################CREATE MAPS

m1<-read.csv("predictions/m7_preds_empirical.csv")
m2<-read.csv("predictions/m8_preds_empirical.csv")
m2b<-read.csv("predictions/m9_preds_empirical.csv")
m3<-read.csv("predictions/m10_preds_empirical.csv")
m4<-read.csv("predictions/m11_preds_empirical.csv")
m5<-read.csv("predictions/m12_preds_empirical.csv")
...
#load in test data
test.in<-read.csv("fl2_test_newpoints.csv")
...
pred.m1(test.in,"predictions/preds_m7_test_b.csv")
pred.m2(test.in,"predictions/preds_m8_test_b.csv")
pred.m3(test.in,"predictions/preds_m9_test_b.csv")
pred.m4(test.in,"predictions/preds_m10_test_b.csv")
pred.m5(test.in,"predictions/preds_m11_test_b.csv")
pred.m6(test.in,"predictions/preds_m12_test_b.csv")


#load in predictions
pred.m1.in<-read.csv("preds_m7_test.csv")
pred.m2.in<-read.csv("preds_m8_test.csv")
pred.m3.in<-read.csv("preds_m9_test.csv")
pred.m4.in<-read.csv("preds_m10_test.csv")
pred.m5.in<-read.csv("preds_m11_test.csv")
pred.m6.in<-read.csv("preds_m12_test.csv")
...
write.csv(m1.in.acc,"accuracy/m1.train.acc.csv")
...
write.csv(m2.in.acc,"accuracy/m2.train.acc.csv")
...
write.csv(m3.in.acc,"m3.train.acc.csv")
...
write.csv(m4.in.acc,"accuracy/m4.train.acc.csv")
...
write.csv(m5.in.acc,"accuracy/m5.train.acc.csv")
...
path<-read.csv("predictions/all_preds_m7_m12_emp.csv")
...
m1_a<-read.csv("pred_m7_sima.csv")
m1_c<-read.csv("pred_m7_simc.csv")
m1_d<-read.csv("pred_m7_simd.csv")

m2_a<-read.csv("pred_m8_sima.csv")
m2_c<-read.csv("pred_m8_simc.csv")
m2_d<-read.csv("pred_m8_simd.csv")

m3_a<-read.csv("pred_m9_sima.csv")
m3_c<-read.csv("pred_m9_simc.csv")
m3_d<-read.csv("pred_m9_simd.csv")

m4_a<-read.csv("pred_m10_sima.csv")
m4_c<-read.csv("pred_m10_simc.csv")
m4_d<-read.csv("pred_m10_simd.csv")

m5_a<-read.csv("pred_m11_sima.csv")
m5_c<-read.csv("pred_m11_simc.csv")
m5_d<-read.csv("pred_m11_simd.csv")

m6_a<-read.csv("pred_m12_sima.csv")
m6_c<-read.csv("pred_m12_simc.csv")
m6_d<-read.csv("pred_m12_simd.csv")
