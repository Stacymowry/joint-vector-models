...
calc_yhat(quants_m1a_10,diff_m1a_10,mean_m1a_10,
          "/yhat_m1path_a_10.csv",
          "/avgs_m1path_a_10.csv")

calc_yhat(quants_m2a_10,diff_m2a_10,mean_m2a_10,
          "/yhat_m2path_a_10.csv",
          "/avgs_m2path_a_10.csv")

calc_yhat(quants_m3a_10,diff_m3a_10,mean_m3a_10,
          "/yhat_m3path_a_10.csv",
          "/avgs_m3path_a_10.csv")

calc_yhat(quants_m4a_10,diff_m4a_10,mean_m4a_10,
          "/yhat_m4path_a_10.csv",
          "/avgs_m4path_a_10.csv")

calc_yhat(quants_m5a_10,diff_m5a_10,mean_m5a_10,
          "/yhat_m5path_a_10.csv",
          "/avgs_m5path_a_10.csv")

calc_yhat(quants_m6a_10,diff_m6a_10,mean_m6a_10,
          "/yhat_m6path_a_10.csv",
          "/avgs_m6path_a_10.csv")
...
calc_yhat(quants_m1c_3,diff_m1c_3,mean_m1c_3,
          "/test_preds/yhat_m1path_c_3.csv",
          "/test_preds/avgs_m1path_c_3.csv")

calc_yhat(quants_m2c_3,diff_m2c_3,mean_m2c_3,
          "/test_preds/yhat_m2path_c_3.csv",
          "/test_preds/avgs_m2path_c_3.csv")

calc_yhat(quants_m3c_3,diff_m3c_3,mean_m3c_3,
          "/test_preds/yhat_m3path_c_3.csv",
          "/test_preds/avgs_m3path_c_3.csv")

calc_yhat(quants_m4c_3,diff_m4c_3,mean_m4c_3,
          "/test_preds/yhat_m4path_c_3.csv",
          "/test_preds/avgs_m4path_c_3.csv")

calc_yhat(quants_m5c_3,diff_m5c_3,mean_m5c_3,
          "/test_preds/yhat_m5path_c_3.csv",
          "/test_preds/avgs_m5path_c_3.csv")

calc_yhat(quants_m6c_3,diff_m6c_3,mean_m6c_3,
          "/test_preds/yhat_m6path_c_3.csv",
          "/test_preds/avgs_m6path_c_3.csv")
...
calc_yhat(quants_m1c_10,diff_m1c_10,mean_m1c_10,
          "yhat_m1path_c_10.csv",
          "~/avgs_m1path_c_10.csv")

calc_yhat(quants_m2c_10,diff_m2c_10,mean_m2c_10,
          "~/yhat_m2path_c_10.csv",
          "~/avgs_m2path_c_10.csv")

calc_yhat(quants_m3c_10,diff_m3c_10,mean_m3c_10,
          "~/yhat_m3path_c_10.csv",
          "~/avgs_m3path_c_10.csv")

calc_yhat(quants_m4c_10,diff_m4c_10,mean_m4c_10,
          "~/yhat_m4path_c_10.csv",
          "~/avgs_m4path_c_10.csv")

calc_yhat(quants_m5c_10,diff_m5c_10,mean_m5c_10,
          "~/yhat_m5path_c_10.csv",
          "~/avgs_m5path_c_10.csv")

calc_yhat(quants_m6c_10,diff_m6c_10,mean_m6c_10,
          "~/yhat_m6path_c_10.csv",
          "~/avgs_m6path_c_10.csv")

##load in outputs
##Sim A
m1a_1<-read.csv("/avgs_m1path_a_1.csv")
m2a_1<-read.csv("/avgs_m2path_a_1.csv")
m3a_1<-read.csv("/avgs_m3path_a_1.csv")
m4a_1<-read.csv("/avgs_m4path_a_1.csv")
m5a_1<-read.csv("/avgs_m5path_a_1.csv")
m6a_1<-read.csv("/avgs_m6path_a_1.csv")

m1a_2<-read.csv("avgs_m1path_a_2.csv")
m2a_2<-read.csv("/avgs_m2path_a_2.csv")
m3a_2<-read.csv("/avgs_m3path_a_2.csv")
m4a_2<-read.csv("/avgs_m4path_a_2.csv")
m5a_2<-read.csv("/avgs_m5path_a_2.csv")
m6a_2<-read.csv("/avgs_m6path_a_2.csv")

m1a_3<-read.csv("avgs_m1path_a_3.csv")
m2a_3<-read.csv("/avgs_m2path_a_3.csv")
m3a_3<-read.csv("/avgs_m3path_a_3.csv")
m4a_3<-read.csv("/avgs_m4path_a_3.csv")
m5a_3<-read.csv("/avgs_m5path_a_3.csv")
m6a_3<-read.csv("/avgs_m6path_a_3.csv")

m1a_4<-read.csv("avgs_m1path_a_4.csv")
m2a_4<-read.csv("/avgs_m2path_a_4.csv")
m3a_4<-read.csv("/avgs_m3path_a_4.csv")
m4a_4<-read.csv("/avgs_m4path_a_4.csv")
m5a_4<-read.csv("/avgs_m5path_a_4.csv")
m6a_4<-read.csv("/avgs_m6path_a_4.csv")

m1a_5<-read.csv("avgs_m1path_a_5.csv")
m2a_5<-read.csv("/avgs_m2path_a_5.csv")
m3a_5<-read.csv("/avgs_m3path_a_5.csv")
m4a_5<-read.csv("/avgs_m4path_a_5.csv")
m5a_5<-read.csv("/avgs_m5path_a_5.csv")
m6a_5<-read.csv("/avgs_m6path_a_5.csv")

m1a_6<-read.csv("/avgs_m1path_a_6.csv")
m2a_6<-read.csv("/avgs_m2path_a_6.csv")
m3a_6<-read.csv("/avgs_m3path_a_6.csv")
m4a_6<-read.csv("/avgs_m4path_a_6.csv")
m5a_6<-read.csv("/avgs_m5path_a_6.csv")
m6a_6<-read.csv("/avgs_m6path_a_6.csv")

m1a_7<-read.csv("/avgs_m1path_a_7.csv")
m2a_7<-read.csv("/avgs_m2path_a_7.csv")
m3a_7<-read.csv("/avgs_m3path_a_7.csv")
m4a_7<-read.csv("/avgs_m4path_a_7.csv")
m5a_7<-read.csv("/avgs_m5path_a_7.csv")
m6a_7<-read.csv("/avgs_m6path_a_7.csv")

m1a_8<-read.csv("/avgs_m1path_a_8.csv")
m2a_8<-read.csv("/avgs_m2path_a_8.csv")
m3a_8<-read.csv("/avgs_m3path_a_8.csv")
m4a_8<-read.csv("/avgs_m4path_a_8.csv")
m5a_8<-read.csv("/avgs_m5path_a_8.csv")
m6a_8<-read.csv("/avgs_m6path_a_8.csv")

m1a_9<-read.csv("/avgs_m1path_a_9.csv")
m2a_9<-read.csv("/avgs_m2path_a_9.csv")
m3a_9<-read.csv("/avgs_m3path_a_9.csv")
m4a_9<-read.csv("/avgs_m4path_a_9.csv")
m5a_9<-read.csv("/avgs_m5path_a_9.csv")
m6a_9<-read.csv("avgs_m6path_a_9.csv")

m1a_10<-read.csv("/avgs_m1path_a_10.csv")
m2a_10<-read.csv("/avgs_m2path_a_10.csv")
m3a_10<-read.csv("/avgs_m3path_a_10.csv")
m4a_10<-read.csv("/avgs_m4path_a_10.csv")
m5a_10<-read.csv("/avgs_m5path_a_10.csv")
m6a_10<-read.csv("avgs_m6path_a_10.csv")

##Sim C

m1c_1<-read.csv("/avgs_m1path_c_1.csv")
m2c_1<-read.csv("/avgs_m2path_c_1.csv")
m3c_1<-read.csv("/avgs_m3path_c_1.csv")
m4c_1<-read.csv("/avgs_m4path_c_1.csv")
m5c_1<-read.csv("/avgs_m5path_c_1.csv")
m6c_1<-read.csv("avgs_m6path_c_1.csv")

m1c_2<-read.csv("/avgs_m1path_c_2.csv")
m2c_2<-read.csv("/avgs_m2path_c_2.csv")
m3c_2<-read.csv("/avgs_m3path_c_2.csv")
m4c_2<-read.csv("/avgs_m4path_c_2.csv")
m5c_2<-read.csv("/avgs_m5path_c_2.csv")
m6c_2<-read.csv("/avgs_m6path_c_2.csv")

m1c_3<-read.csv("test_preds/avgs_m1path_c_3.csv")
m2c_3<-read.csv("/test_preds/avgs_m2path_c_3.csv")
m3c_3<-read.csv("/test_preds/avgs_m3path_c_3.csv")
m4c_3<-read.csv("/test_preds/avgs_m4path_c_3.csv")
m5c_3<-read.csv("/test_preds/avgs_m5path_c_3.csv")
m6c_3<-read.csv("/test_preds/avgs_m6path_c_3.csv")

m1c_4<-read.csv("/avgs_m1path_c_4.csv")
m2c_4<-read.csv("/avgs_m2path_c_4.csv")
m3c_4<-read.csv("/avgs_m3path_c_4.csv")
m4c_4<-read.csv("/avgs_m4path_c_4.csv")
m5c_4<-read.csv("/avgs_m5path_c_4.csv")
m6c_4<-read.csv("/avgs_m6path_c_4.csv")

m1c_5<-read.csv("/avgs_m1path_c_5.csv")
m2c_5<-read.csv("/avgs_m2path_c_5.csv")
m3c_5<-read.csv("/avgs_m3path_c_5.csv")
m4c_5<-read.csv("/avgs_m4path_c_5.csv")
m5c_5<-read.csv("/avgs_m5path_c_5.csv")
m6c_5<-read.csv("/avgs_m6path_c_5.csv")

m1c_6<-read.csv("/avgs_m1path_c_6.csv")
m2c_6<-read.csv("/avgs_m2path_c_6.csv")
m3c_6<-read.csv("/avgs_m3path_c_6.csv")
m4c_6<-read.csv("/avgs_m4path_c_6.csv")
m5c_6<-read.csv("/avgs_m5path_c_6.csv")
m6c_6<-read.csv("/avgs_m6path_c_6.csv")

m1c_7<-read.csv("/avgs_m1path_c_7.csv")
m2c_7<-read.csv("/avgs_m2path_c_7.csv")
m3c_7<-read.csv("/avgs_m3path_c_7.csv")
m4c_7<-read.csv("/avgs_m4path_c_7.csv")
m5c_7<-read.csv("/avgs_m5path_c_7.csv")
m6c_7<-read.csv("/avgs_m6path_c_7.csv")

m1c_8<-read.csv("/avgs_m1path_c_8.csv")
m2c_8<-read.csv("/avgs_m2path_c_8.csv")
m3c_8<-read.csv("/avgs_m3path_c_8.csv")
m4c_8<-read.csv("/avgs_m4path_c_8.csv")
m5c_8<-read.csv("/avgs_m5path_c_8.csv")
m6c_8<-read.csv("/avgs_m6path_c_8.csv")

m1c_9<-read.csv("/avgs_m1path_c_9.csv")
m2c_9<-read.csv("/avgs_m2path_c_9.csv")
m3c_9<-read.csv("/avgs_m3path_c_9.csv")
m4c_9<-read.csv("/avgs_m4path_c_9.csv")
m5c_9<-read.csv("/avgs_m5path_c_9.csv")
m6c_9<-read.csv("/avgs_m6path_c_9.csv")

m1c_10<-read.csv("~/avgs_m1path_c_10.csv")
m2c_10<-read.csv("~/avgs_m2path_c_10.csv")
m3c_10<-read.csv("~/avgs_m3path_c_10.csv")
m4c_10<-read.csv("~/avgs_m4path_c_10.csv")
m5c_10<-read.csv("~/avgs_m5path_c_10.csv")
m6c_10<-read.csv("~/avgs_m6path_c_10.csv")
