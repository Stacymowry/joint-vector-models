...
##load in predictions
data_m1<-read.csv("m1c_run1_full.csv")
data_m2<-read.csv("m2c_run1_full.csv")
data_m3<-read.csv("m3c_run1_full.csv")
data_m4<-read.csv("m4c_run1_full.csv")
data_m5<-read.csv("m5c_run1_full.csv")
data_m6<-read.csv("m6c_run1_full.csv")
data_m7<-read.csv("m7c_run1_full.csv")
data_m8<-read.csv("m8c_run1_full.csv")
data_m9<-read.csv("m9c_run1_full.csv")
data_m10<-read.csv("m10c_run1_full.csv")
data_m11<-read.csv("m11c_run1_full.csv")
data_m12<-read.csv("m12c_run1_full.csv")


##load in outline
outline<-read.csv("gridsp.csv")
